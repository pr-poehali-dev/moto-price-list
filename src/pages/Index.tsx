...
const categories: Category[] = [
  ...
  { id: '9', name: 'Yamaha', image: 'https://cdn.poehali.dev/files/fd733e33-5155-4547-bc59-5283a61ad564.jpg', route: '/category/yamaha' },
  { id: '10', name: 'АКЦИЯ!!!! (цена указана за количество которое стоит в скобках)', image: 'https://cdn.poehali.dev/files/ccb02bbf-9c0d-4efb-a1e6-efa74ac3a416.jpg', route: '/sales' },
